...
| 文档 | 内容 | 篇幅 |
|:---|:---|:---:|
| [向量数据库选型指南](../../docs/02-tech-stack/29-vector-database-selection.md) | Milvus / FAISS / Chroma / Qdrant / Pinecone 五个核心向量库的详细对比、决策树与性能数据 | 226 行 |
...
1. **[向量数据库选型指南](../../docs/02-tech-stack/29-vector-database-selection.md)** —— 先搞清楚检索层用什么，里面有决策树和面试常见的选型追问
